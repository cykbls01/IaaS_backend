    ...
    public class CommonAPIController : ApiController
    {
        ...
        public HttpResponseMessage GetInfo()
        {
            ...
            try
            {
                ...
                retData.Add("role", user.role.ToString());
                retData.Add("nickname", user.nick_name);
            ...
            try
            {
                ...
                if (nickname != null)
                {
                    if (UserDao.GetUserByNickName(nickname) != null)
                        return new Response(3001, "登录名已存在").Convert();
                }
                UserDao.ChangeInfo(id, name, email, nickname);
