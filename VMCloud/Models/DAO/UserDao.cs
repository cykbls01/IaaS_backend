...
namespace VMCloud.Models.DAO
{
    public class UserDao
    {
        ...
        public static User GetUserByNickname(string nickname)
        {
            using (var dbContext = new DataModels())
            {
                User user = dbContext.Users.First(u => u.nick_name.Equals(nickname));
                return user;
            }
        }
       ...
       * 根据id，修改个人信息
       */
        public static void ChangeInfo(string userId, string name, string email, string nickName = null)
        {
            using (var dbContext = new DataModels())
            {
       ...
       */
        ...
        public static int DeleteAstFromCourse(Assistant ast)
        {
            using (var dbContext = new DataModels())
            {
                ...
                dbContext.Assistants.Remove(assts.First());
                return dbContext.SaveChanges();
            }
        }
        /// <summary>
